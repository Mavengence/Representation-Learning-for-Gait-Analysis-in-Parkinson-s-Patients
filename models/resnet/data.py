...
class ParkinsonDataModuleResNet(pl.LightningDataModule):    
    def __init__(self, max_batch_len = 4096, num_workers=0, batch_size=32):
        ...
        self.root_dir="./data/resnet"
        self.csv_file_train ="ResNet_train.csv"
        self.csv_file_val ="ResNet_val.csv"
        self.csv_file_test ="ResNet_test.csv"
