...
class ParkinsonDataModuleAE(pl.LightningDataModule):    
    def __init__(self, max_batch_len = 4096, num_workers=0):
        super().__init__()
        self.max_batch_len = max_batch_len
        ...
        self.test_df = None
        self.val_df = None
        self.root_dir="./data/autoencoder_sample"
        self.csv_file_train ="autoenc_train_df.csv"
        self.csv_file_test ="autoenc_test_df.csv"
    ...
    def prepare_data(self):
        ...
        self.val_df = pd.read_csv(os.path.join(self.root_dir, self.csv_file_test))
